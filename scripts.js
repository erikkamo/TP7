...
window.onload = function() {
  ...
  document.querySelector("#equipment").onclick = function() {
    document.querySelector("#equipment ul").classList.toggle("hide");
  }
  document.querySelector("#directions").onclick = function() {
    document.querySelector("#directions ol").classList.toggle("hide");
  }
  
  document.querySelector("#footer").innerHTML += "Page Built by Erikka Moore";
